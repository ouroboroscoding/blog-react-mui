 ...
 */
export default function New({ allowedMeta, basePath, baseURL, tinymceKey }) {
    // Text
    ...
    return (React.createElement(Box, { id: "blog_new_post" },
        React.createElement(Box, { className: "blog_new_post_content" },
            React.createElement(HTML, { error: 'content' in error ? error.content : false, ref: refHtml, tinymceKey: tinymceKey })),
        fullScreen &&
