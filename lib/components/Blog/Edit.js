 ...
 */
export default function Edit({ _id, allowedMeta, baseURL, tinymceKey }) {
    // Text
    ...
    return (React.createElement(Box, { id: "blog_post_edit" },
        React.createElement(Box, { className: "blog_post_edit_content" },
            React.createElement(HTML, { error: 'content' in error ? error.content : false, tinymceKey: tinymceKey, ref: refHtml, value: loc === 'new' ? newLang.content : post.locales[loc].content })),
        fullScreen &&
