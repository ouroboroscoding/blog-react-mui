 ...
 */
export default function Blog({ allowedMeta = ['title', 'description', 'image', 'url'], basePath = '/blog', baseURL = 'http://localhost', locale = 'en-US', tinymceKey }) {
    // State
    ...
    return (React.createElement(Box, { id: "blog" },
        ...
        React.createElement(Box, { id: "blog_content" }, (tab === TAB_MAP.home &&
            ...
            React.createElement(New, { allowedMeta: allowedMeta, basePath: basePath, baseURL: baseURL, tinymceKey: tinymceKey })) || (tab === TAB_MAP.published &&
            ...
            React.createElement(Edit, { _id: id, allowedMeta: allowedMeta, baseURL: baseURL, tinymceKey: tinymceKey })) || (tab === TAB_MAP.invalid &&
